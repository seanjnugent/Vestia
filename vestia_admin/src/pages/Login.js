  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-[#3971cc] via-[#3b92cc] to-[#57cbeb]" />
        <div
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96">
        ...
        <img src="/vestia-admin.svg" alt="Vestia Logo" className="h-20 w-20" /> {/* Adjust size of logo */}
</div>
