...
const NewClient = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    clientProfile: { id: '', label: '' }, // Updated to JSON object
    emailAddress: '',
    phoneNumber: '',
  });
  ...
  const handleProfileChange = (e) => {
    const selectedProfile = riskProfiles.find((profile) => profile.id === e.target.value);
    setFormData({
      ...formData,
      clientProfile: selectedProfile || { id: '', label: '' },
    });
  };
        ...
        return (
          <>
            ...
            <TextField
              ...
              required
              value={formData.clientProfile.id}
